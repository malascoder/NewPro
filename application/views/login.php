...
<head>
  ...
  <link rel="stylesheet" href="<?php echo("assets/vendor/fontawesome-free/css/all.min.css")?>" type="text/css">
  ...
  <link rel="stylesheet" href="<?php echo("assets/css/sb-admin-2.min.css")?>" rel="stylesheet">
      ...
      <div class="col-xl-10 col-lg-12 col-md-9">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-6"><img src="<?php echo("assets/img/logo.png")?>"></div>
              <div class="col-lg-6">
                <div class="p-5">
